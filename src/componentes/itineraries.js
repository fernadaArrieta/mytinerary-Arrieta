      ...
      <h1 className="tituloTineray">Hard Rock Coffe</h1>
          ...
          <div className="cont-contenido">
              ...
              <div className="headerTinerary">                                   
                  <img className="fotoUsuario" src="https://media.revistagq.com/photos/5ca5faccd71dd9afe59582ae/1:1/w_1165,h_1165,c_limit/brad_pitt_50_anos_hombre_joven_cuidados_cosmetica_678.jpg" alt="fotoUsuario"/>
                  <h3 className="nombreUsuario">Brad Pitt</h3>
                  <FavoriteBorderIcon sx={{ color: "pink" }}/>
                  </div> 

                <div className="bodyTinerary">
                    <h3 className="nombreUsuario">Excellent place to have a good time and have good drinks!!!</h3>
              ...
              <div className="btnDrop"><SelectVariants/></div> 
      </div>
